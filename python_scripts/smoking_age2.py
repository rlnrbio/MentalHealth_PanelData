# -*- coding: utf-8 -*-
"""
Created on Sun Jul 10 22:42:02 2022
...
sns.lineplot(data=total_combined, x="age", y="mcs_std", hue="sex", style="sex")
plt.savefig("figures/age_mcs_sex.png")
plt.clf()

fig1 = plt.figure(figsize = (8,6))
sns.lineplot(data=total_combined, x="age", y="pcs_std", hue="sex", style="sex")
plt.savefig("figures/age_pcs_sex.png")
plt.clf()

fig2 = plt.figure(figsize = (8,6))
total_combined_age2 = total_combined.copy()
total_combined_age2["age"] = np.power(total_combined_age2["age"], 3)
sns.lineplot(data=total_combined_age2, x="age", y="mcs_std", hue="sex", style="sex")
plt.savefig("figures/age^3_mcs_sex.png")
plt.clf()

fig3= plt.figure(figsize = (8,6))
sns.lineplot(data=total_combined, x="gebjahr", y="mcs_std", hue="syear")
plt.savefig("figures/gebjahr_mcs_syear.png")
plt.clf()

fig4 = plt.figure(figsize = (8,6))
sns.lineplot(data=total_combined, x="age", y="mcs_std", hue="syear")
plt.savefig("figures/age_mcs_syear.png")
plt.clf()

fig5 = plt.figure(figsize = (8,6))
sns.lineplot(data=total_combined, x="age", y="mcs_std", hue="ple0081_v2")
plt.savefig("figures/age_mcs_smoking.png")
plt.clf()
